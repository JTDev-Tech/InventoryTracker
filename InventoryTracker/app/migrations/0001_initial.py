    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Postfix', models.CharField(help_text='Unit pre or post fix for this unit', max_length=5, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='PackageModel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DataSheet', models.FileField(help_text='Datasheet for this part', null=True, upload_to='data_sheets/%m/')),
                ('Attributes', models.ManyToManyField(help_text='Part this attribute is assigned to', to='app.PartAttrModel')),
                ...
                ('Unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.MeasurementUnitModel')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='measurementunitmodel',
            name='PartCategory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.PartCategoryModel'),
        ),
        migrations.CreateModel(
            name='ContainerModel',
            fields=[
